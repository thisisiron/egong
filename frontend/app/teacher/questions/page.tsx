...
export default async function TeacherQuestionsPage() {
  ...
  return (
    <div className="space-y-4">
      ...
      <QuestionList questions={questions} basePath="/teacher/questions" unresolvedOnly />
      <details className="text-sm">
        <summary className="cursor-pointer text-slate-500">해결된 질문 보기</summary>
        <div className="mt-2"><QuestionList questions={questions.filter((q) => q.is_resolved)} basePath="/teacher/questions" /></div>
      </details>
    </div>
  )
}
